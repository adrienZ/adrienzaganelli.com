  ...
  <svg style="position: absolute; width: 0; height: 0; overflow: hidden;" version="1.1"
    ...
    <defs>
      <symbol id="icon-linkedin" viewBox="0 0 24 24">
        ...
        <path class="st0" d="M16.5,8.2c-1.4,0-2.7,0.6-3.5,1.7V9H9v11h4v-7c0-1.1,0.9-2,2-2s2,0.9,2,2v7h4v-7.2C21,10.3,19,8.2,16.5,8.2z"></path>
      </symbol>
      ...
      <symbol id="icon-rss" viewBox="0 0 448 448">
        <title>Rss</title>
      ...
      <symbol id="icon-logo" viewBox="0 0 412.17 464.41">
        ...
        <polyline stroke="#231f20" stroke-miterlimit="10" stroke-linecap="round" fill="none" stroke-width="4px" points="197.6 2 277 164.6 302.5 216.8"></polyline>
        <polyline stroke="#231f20" stroke-miterlimit="10" stroke-linecap="round" fill="none" stroke-width="4px" points="197.6 2 125.6 164.2 102.2 216.8"></polyline>
