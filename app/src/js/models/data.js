...
export default [
  ...
  },
  {
    ...
    name: 'MARKET-ME.FR',
    file: 'marketme.html',
    description: 'First job, The AgenceMe team (2 developers, 2 designers, 1 marketing) and I build a creative marketplace from scratch in 2 months.',
  ...
  },
  {
    ...
    name: 'Sketchfab',
    file: 'skfb.html',
    description: 'Second summer internship, 3 months dive into the WebGL world and the startup ecosystem. Sketchfab is all about 3D and community.',
  ...
  },
  {
    ...
    name: 'Alium',
    file: 'alium.html',
    description: 'One semester to build a high quality bike brand for a real client. Modern design and a custom wordpress theme.',
